                    ...
                    <div class="col-lg-6">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                ...
                                <a href="<?= STATIC_URL ?>docs/Jaarverslag en jaarrekening Jan Roëde Stichting 2025 (te publiceren op website).pdf" target="_blank" class="btn btn-outline-secondary btn-sm me-2"><i class="fa-regular fa-file-pdf me-1"></i> PDF</a>
                                <a href="<?= STATIC_URL ?>docs/Jaarverslag en jaarrekening Jan Roëde Stichting 2025 (te publiceren op website).docx" target="_blank" class="btn btn-outline-secondary btn-sm"><i class="fa-regular fa-file-word me-1"></i> Word</a>
                            </li>
                            <li class="mb-2">
                                <strong>Jaarverslag 2024</strong> &mdash;
                                <a href="<?= STATIC_URL ?>docs/Jaarverslag en jaarrekening Jan Roëde Stichting 2024 (voor publicatie).pdf" target="_blank" class="btn btn-outline-secondary btn-sm me-2"><i class="fa-regular fa-file-pdf me-1"></i> PDF</a>
                                <a href="<?= STATIC_URL ?>docs/Jaarverslag en jaarrekening Jan Roëde Stichting 2024 (voor publicatie).docx" target="_blank" class="btn btn-outline-secondary btn-sm"><i class="fa-regular fa-file-word me-1"></i> Word</a>
                            </li>
                        </ul>
                    </div>
                </div>
