...
<section id="faq">
    <div class="container" style="overflow:hidden;">
        <div class="row">
            ...
            <small>Staat uw vraag er niet tussen? Neem gerust contact op via ons <a href="<?= SITE_URL ?>contact">contactformulier</a> of bel ons op <a href="tel:<?= $COMPANY_PHONE_LINK ?>"><?= $COMPANY_PHONE ?></a>.</small>
        </div>
</section>