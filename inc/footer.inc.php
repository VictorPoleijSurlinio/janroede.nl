<footer>
	<div class="container">
		...
		<div class="col-lg-4">
				...
				<?php $today = date('l'); $dayMap = ['Monday'=>'Maandag','Tuesday'=>'Dinsdag','Wednesday'=>'Woensdag','Thursday'=>'Donderdag','Friday'=>'Vrijdag','Saturday'=>'Zaterdag','Sunday'=>'Zondag']; $todayNl = $dayMap[$today] ?? ''; ?>
		...
		<div class="row pt-4">
			<hr class="secondary-color" style="height:3px;">
